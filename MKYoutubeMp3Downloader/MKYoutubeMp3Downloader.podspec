...
Then using a ffmpeg external swift library will convert the video in mp3.
  ...
  # s.source           = { :git => 'https://github.com/Madrit Kacabumi/MKYoutubeToMp3Downloader.git', :tag => s.version.to_s }
    s.source         = { :path => '/Users/madritkacabumi/Documents/Workspace/iOS/libraries/MKYoutubeMp3Downloader/' }
  ...
  # s.resource_bundles = {
  #   'MKYoutubeToMp3Downloader' => ['MKYoutubeToMp3Downloader/Assets/*.png']
  # }

  # s.public_header_files = 'MKYoutubeMp3Downloader/Enviroment/NodeMobile.framework/Headers/NodeMobile.h'
  # s.dependency = 'NodeMobile'
